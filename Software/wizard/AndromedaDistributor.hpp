...
protected:
    ...
    virtual size_t fragmentCountOnLeftEdge() const;
    virtual size_t fragmentCountOnTopEdge() const;
    virtual size_t fragmentCountOnBottomEdge() const;
    virtual size_t fragmentCountOnRightEdge() const;
