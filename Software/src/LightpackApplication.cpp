...
//    connect(settings(), SIGNAL(requestFirmwareVersion()),       m_ledDeviceManager, SLOT(requestFirmwareVersion()), Qt::QueuedConnection);
...
void LightpackApplication::numberOfLedsChanged(int numOfLeds)
{
