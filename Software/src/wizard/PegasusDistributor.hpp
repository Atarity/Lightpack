...
#ifndef PEGASUSDISTRIBUTOR_HPP
#define PEGASUSDISTRIBUTOR_HPP
#include "AreaDistributor.hpp"

class PegasusDistributor : public AreaDistributor
{
public:
    PegasusDistributor(int screenId, size_t areaCount):
        AreaDistributor(screenId, areaCount),
        _dx(0), _dy(0)
    {}

    virtual ~PegasusDistributor();
