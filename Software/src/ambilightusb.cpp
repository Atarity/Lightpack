...
//    for(int i=1; i<256; i++){
    int i = 0;
        qDebug() << "usbInterruptRead 1";
        int res = usbInterruptRead(ambilightDevice, buffer, sizeof(buffer), i);
        qDebug() << i << " res =" << res;
//    }
...
//
//
//    write_buffer[1] =CMD_LEDS_3_4;
//    write_buffer[2] = (unsigned char)colors[LED3]->r;
//    write_buffer[3] = (unsigned char)colors[LED3]->g;
//    write_buffer[4] = (unsigned char)colors[LED3]->b;
//
//    write_buffer[5] = (unsigned char)colors[LED4]->r;
//    write_buffer[6] = (unsigned char)colors[LED4]->g;
//    write_buffer[7] = (unsigned char)colors[LED4]->b;
//    write_buffer[8] = 0x00;
//
//
//    qDebug() << "usbInterruptRead 2 " << usbInterruptRead(ambilightDevice, buffer, size);
//
////    writeBufferToDeviceWithCheck();
//
//    usleep(5000);
//
//
//   write_buffer[1] = CMD_LEDS_5_6;
//   write_buffer[2] = (unsigned char)colors[LED5]->r;
//   write_buffer[3] = (unsigned char)colors[LED5]->g;
//   write_buffer[4] = (unsigned char)colors[LED5]->b;
//
//   write_buffer[5] = (unsigned char)colors[LED6]->r;
//   write_buffer[6] = (unsigned char)colors[LED6]->g;
//   write_buffer[7] = (unsigned char)colors[LED6]->b;
//   write_buffer[8] = 0x00;
//
//   qDebug() << "usbInterruptRead 3 " << usbInterruptRead(ambilightDevice, buffer, size);
//
////   writeBufferToDeviceWithCheck();
//
//   usleep(5000);
//
//
//   write_buffer[1] = CMD_LEDS_7_8;
//   write_buffer[2] = (unsigned char)colors[LED7]->r;
//   write_buffer[3] = (unsigned char)colors[LED7]->g;
//   write_buffer[4] = (unsigned char)colors[LED7]->b;
//
//   write_buffer[5] = (unsigned char)colors[LED8]->r;
//   write_buffer[6] = (unsigned char)colors[LED8]->g;
//   write_buffer[7] = (unsigned char)colors[LED8]->b;
//   write_buffer[8] = 0x00;
//
//
//   qDebug() << "usbInterruptRead 4 " << usbInterruptRead(ambilightDevice, buffer, size);
//
////   writeBufferToDeviceWithCheck();
//
//    usleep(5000);
