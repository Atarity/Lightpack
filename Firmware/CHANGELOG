...
* Added codes form LUFA project
* Firmware based on GenericHID demo from LUFA
* See hardware changes verison 4.0 for details (AT90USB162, ...) 
* Rename project AmbilightUSB to Lightpack

Version fw4.0
-------------
brunql, January 4, 2011

* See hardware changes verison 4.0 for details (2 x ATmega8)
* Two firmwares: first ATmega8 - USB<->UART; second ATmega8 - UART<->PWM;
* This version works without flickering while USB data transfers, but hardware sucks
