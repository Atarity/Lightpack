...
2. Configure and build **Qt** with sequence of commands: `./con?gure -opensource -nomake examples -nomake tests —no-webkit`, then `make -j 4`, and `make install`. It will take some time
