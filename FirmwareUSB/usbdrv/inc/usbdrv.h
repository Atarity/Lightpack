...
#define usbDeviceConnect()      (USBDDR &= (uint8_t)~(1<<USBMINUS))
...
#define usbCrc16(data, len) usbCrc16((uint16_t)(data), len)
...
#define usbCrc16Append(data, len)    usbCrc16Append((uint16_t)(data), len)
...
extern volatile int8_t   usbRxLen;
